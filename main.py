...
def check_resources(coffee):
    ...
    not_enough = 0
    # print(f"На выбранный кофе нужны следующие ресурсы: {local_coffee}")
    # print(f"В машине вот столько всего: {resources}")
    # print(f"Ингридиенты на подготовку {coffee}: {local_coffee['ingredients']}")
...
def coffe_machine():
    ...
    # TODO: 5. Если ресурсов хватает, то прошу внести деньги
    ...
    # TODO: 6. Проверка хватает ли денег
...
while not END_MACHINE:
    ...
    # TODO: 3. Print report if question is report
    ...
    # TODO: 4. Проверить количество оставшихся ресурсов
